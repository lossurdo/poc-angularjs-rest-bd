...
public class AuthFilter implements ContainerRequestFilter, ContainerResponseFilter {
    ...
    /**
     * Quando informado USUARIO/SENHA no HEADER da chamada HTTP, faz a validação
     * destes, empacotando o payload, gerando o Token e adicionando-o ao
     * RESPONSE do HTTP.
     *
     * @param requestContext
    ...
    public void filter(ContainerRequestContext requestContext, ContainerResponseContext responseContext) {
        ...
        if (informadoHeader("usuario", requestContext)
            ...
            if (!"admin".equals(requestContext.getHeaderString("usuario"))
                    || !"admin".equals(requestContext.getHeaderString("senha"))) {
